...
_LLM_CONFIGS_IMPORT_MAP = {
    ...
    "QwenPortalConfig": (".llms.qwen_portal.chat.transformation", "QwenPortalConfig"),
    "GeminiCLIConfig": (".llms.gemini_cli.chat.transformation", "GeminiCLIConfig"),
    "KimiCodeConfig": (".llms.kimi_code.chat.transformation", "KimiCodeConfig"),
    ...
    "AlibabaChatConfig": (".llms.alibaba.chat.transformation", "AlibabaChatConfig"),
